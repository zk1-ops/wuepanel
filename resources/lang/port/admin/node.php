...
return [
    ...
    'notices' => [
        ...
        'node_created' => 'Novo nó criado com sucesso. Você pode configurar automaticamente o daemon nesta máquina visitando o \'Configuration\' tab. <strong>Antes de adicionar qualquer servidor, você deve primeiro alocar pelo menos um endereço IP e uma porta.</strong>',
        'node_updated' => 'As informações do nó foram atualizadas. Se alguma configuração do daemon foi alterada, você precisará reiniciá-lo para que essas alterações tenham efeito.',
